...
class ParcelHistory extends StatefulWidget {
  ...
  ParcelHistory({this.tripid, this.driver_id});
  @override
...
class History extends State<ParcelHistory> {
  ...
  void getPostsData() async {
    var APIURL =
    Uri.parse('https://votivetech.in/courier/webservice/api/parcelHistory');
                            ...
                            RichText(
                              ...
                              text: TextSpan(
                                ...
                                children: [
                                  ...
                                  TextSpan(text: 'Delivered Date: '),
                                  TextSpan(text: post["updated_date"]),
                                ],
                              ),
                            ),
                          ],
